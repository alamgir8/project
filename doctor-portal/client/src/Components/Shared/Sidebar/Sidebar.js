        ...
        <div className='sidebar-section'>
            <div className="container">
                <nav className="nav flex-column pt-5">
                    ...
                    <Link to="/dashboard/appointments" className="nav-link text-white"> <span className='mx-2'><i className="bi bi-calendar"></i></span> Appointment </Link>
                    <Link to="/dashboard/patients" className="nav-link text-white"> <span className='mx-2'><i className="bi bi-people"></i></span> Patients </Link>
